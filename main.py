...
def test_get_assignments_in_various_states():
    ...
    for itr, result in enumerate(expected_result):
        print(result[0], sql_result[itr][0], result[0] == sql_result[itr][0])
        print(result[1], sql_result[itr][1], result[1] == sql_result[itr][1])
    ...
    #     assert result[0] == sql_result[itr][0]
    #     assert result[1] == sql_result[itr][1]
test_get_assignments_in_various_states()